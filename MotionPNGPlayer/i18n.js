/**
 * MotionPNGPlayer - i18n helper (main process)
 *
 ...
 * Renderer pages receive the merged dictionary via IPC payloads and use a
 * small inline t() helper — no separate renderer module needed.
 */
